# Bosch Eyes Camera Local API
<img src="images/bosch_smart_home.jpg"/>

## Contents

- [Overview](#overview)
- [OpenAPI Documentation](https://camera.local.apidocs.bosch-smarthome.com/)
- [Bruno Collection](bruno/)
- [Video Streaming](streaming/)
- [Best Practice](best_practice/)
  * [Watch this repository](best_practice#watch-this-repository)
  * [Limit the number of requests in a given time period](best_practice#limit-the-number-of-requests-in-a-given-time-period)
  * [Host Verification](best_practice#host-verification)
...
Finally, take a look at the [Best Practice](best_practice/) section in order to establish an optimal communication with the Eyes Camera.

## Terms and Conditions
Robert Bosch Smart Home GmbH, Schockenriedstr. 17, 70565 Stuttgart, Germany ("Bosch Smart Home") provides a description of the local Bosch Eyes Camera REST API, that allows **private, non-profit** Developers ("Developer") to locally control their Bosch Eyes Camera.
...
"Data" refers to data made available by accessing the API of a specific, local and personally owned Eyes Camera ("Camera").
